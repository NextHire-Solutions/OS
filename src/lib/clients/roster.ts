...
export const ROSTER: CanonicalClient[] = [
  ...
  { name: "Cain Realty Group" },
  { name: "Camelot Realty Group", aliases: ["Camelot Realty"] },
  ...
  { name: "Howe Realty Group", aliases: ["Howe Realty"] },
  ...
  { name: "MattC Group" },
  { name: "Momentum Realty", aliases: ["Momentum Lux Realty"] },
  { name: "Norvell&Co Real Estate", aliases: ["Norvell & Co"] },
  { name: "Oz Group" },
  ...
  { name: "RE/MAX Pacific", aliases: ["REMAX Pacific"] },
  ...
  { name: "The RE Home Group of Douglas Realty", aliases: ["The RE Home Group of Douglas Re"] },
  { name: "The Wurst Team" },
